...
printHelp = do
  ...
  putStrLn ""
  putStrLn "Usage:"
  putStrLn "  glados [file]             Compile and run a LISP file"
  putStrLn "  glados --disasm [file]    Disassemble a LISP file"
  putStrLn "  glados --ast [file]       Show AST of a LISP file"
  putStrLn "  glados --compiled [file]  Show compiled code of a LISP file"
  putStrLn "  glados --bytecode [file]  Show bytecode instructions of a LISP file"
  putStrLn "  glados                    Start REPL (interactive mode)"
  putStrLn "  glados --help             Show this help message"
  putStrLn ""
  putStrLn "Examples:"
  putStrLn "  glados program.lisp"
  putStrLn "  glados --disasm program.lisp"
  putStrLn "  glados --ast program.lisp"
  putStrLn "  glados --compiled program.lisp"
