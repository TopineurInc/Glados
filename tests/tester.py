...
(is-odd 7)""", "1"),
        ...
        TestCase("And Short Circuit", "(and #f (div 1 0))", "False"),
        TestCase("Or Short Circuit", "(or #t (div 1 0))", "True"),
...
(quadruple 3)""", "12"),
        ...
        TestCase("Palindrome Research Program", """(define (reverse-loop s idx acc)
  (if (< idx 0)
      acc
      (reverse-loop s
                    (- idx 1)
...
(palindrome-analysis 100 999)""",
                 "Analyse des palindromes entre 100 et 999\nTotal detecte: 90\nPlus petit palindrome: 101\nPlus grand palindrome: 999\nSomme cumulee: 49500\nMoyenne (entier): 550\nResult: 52351"),
    ]
